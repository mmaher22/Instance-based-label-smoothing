...
class DenseNet3(nn.Module):
    def __init__(self, depth, num_classes = 10, growth_rate=12, reduction=0.5, bottleneck=True, dropRate=0.0, in_channels  = 3):
...
def densenet40(num_classes = 10, in_channels = 3):
    return DenseNet3(40, num_classes = num_classes, in_channels = in_channels)
